...
namespace {
struct RaiseToAffine : public impl::RaiseToAffineBase<RaiseToAffine> {
...
struct ForOpRaising : public OpRewritePattern<scf::ForOp> {
  ...
  LogicalResult matchAndRewrite(scf::ForOp loop,
    ...
    if (isAffine(loop)) {
      ...
      auto mergedYieldOp = loop.getRegion().front().getTerminator();
...
namespace mlir {
std::unique_ptr<Pass> polygeist::createRaiseToAffinePass() {
