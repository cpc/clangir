...
#ifndef POLYGEIST_MLIR_UTILS_H
#define POLYGEIST_MLIR_UTILS_H
                  ...
                  mlir::IRMapping mapping = {})
{
  ...
  return rewriter.create<mlir::affine::AffineIfOp> (
    op.getLoc (), op.getResultTypes (), op.getIntegerSet (), lower, true);
}
                     ...
                     mlir::TypeRange types = {})
{
  ...
  for (auto o : op.getOperands ())
    lower.push_back (mapping.lookupOrDefault (o));
  return rewriter.create<mlir::affine::AffineIfOp> (
    op.getLoc (), types, op.getIntegerSet (), lower, true);
}
                     ...
                     mlir::IRMapping mapping = {})
{
  ...
  return rewriter.create<mlir::affine::AffineForOp> (
